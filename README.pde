...
void handlePlayerMovement() {
  ...
  } else if (playerX > 830 && playerX < 900 && playerY > 300 && playerY < 375) {
    enterClass();
...
void drawDormitory() {
  fill(dormColor);
  rect(50, height - 550, 150 * 2.5, 150 * 1.5);

  fill(100, 50, 0);
  triangle(50, height - 550, 50 + 150 * 2.5, height - 550, 50 + 150 * 1.25, height - 550 - 30);

  fill(255);
  rect(80, height - 530, 30, 30);
  rect(120, height - 530, 30, 30);
  rect(80, height - 490, 30, 30);
  rect(120, height - 490, 30, 30);
  ...
  textSize(18);
  textAlign(CENTER);
  text("Гуртожиток", 125 + 150 * 1.25, height - 560);
}
